---
title: "welcome"
description: "Distill 패키지를 사용하지 않고 Quarto로 블로그를 시작하게 된 이유"
author: "박세희"
date: "2024-02-20"
toc: true 
categories: [news, featured, 중급]
freeze: true 
draft: true 
---

::: {writing}
[![Artwork by Allison Horst](writing.webp)](https://allisonhorst.com/horst-hill-collaborations){.lightbox}  
:::
...
* `quarto` (2022 ~ ): 패키지가 아닌 문서 작성 도구  distill 기능을 대부분 계승합니다.   
  ...
  * RStudio 외에 쥬피터노트북, 비쥬얼스튜디오에서도 사용할 수 있어요.  
...
* 개인화 하려면 배워야 할 게 많습니다.  
  * R마크다운, html, css, JS는 기본적으로 이해할 필요가 있어요.  
  * git에 대한 기본 이해도 필요 해요. 
  * Netlify 같은 호스팅 서비스도 필요해요.  
  
* 패키지가 아니라서 클릭 한 번으로 블로그 포스팅 템플릿이 자동 생성되지 않습니.  
...
* 작성한 블로그 자료를 모두 깃헙 내 레포지토리에 업로드(push) 합니다.  
